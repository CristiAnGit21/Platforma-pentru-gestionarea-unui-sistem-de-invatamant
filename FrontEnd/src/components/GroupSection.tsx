    ...
    return (
        <div className="mb-6">
            <button
                ...
                className="w-full flex items-center justify-between p-4 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-purple-200 transition-all group"
            >
                <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                        <h2 className="text-lg font-bold text-gray-800 leading-none">{name}</h2>
                        <p className="text-sm text-gray-500 font-medium">{students.length} Studenți</p>
                    </div>
                </div>
                <svg
            ...
            {isOpen && (
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 animate-fade-in">
                    {students.length === 0 ? (
                        <div className="col-span-full py-10 flex flex-col items-center justify-center bg-gray-50 border border-dashed border-gray-200 rounded-2xl">
                            <p className="text-gray-400 text-sm font-medium">Niciun student în această grupă încă.</p>
                        </div>
                    ) : (
