      ...
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="flex flex-col gap-4 flex-1 items-center">
            ...
            <LinkWithIcon icon={<MessageCircleWarning size={27} />} page="Raportează o problemă" path="/raporteaza" selectedPage={selectedPage} setSelectedPage={setSelectedPage} isExpanded={isExpanded} />
