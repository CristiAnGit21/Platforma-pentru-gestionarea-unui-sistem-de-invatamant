...
const LogIn = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-purple-100 p-4 font-sans">
            <div
                className="bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row max-w-4xl w-full min-h-[600px] overflow-hidden">
                ...
                <div className="p-8 md:p-12 md:pt-16 w-full md:w-2/5 flex flex-col bg-white">
                    <div className="mb-10">
                        ...
                        <p className="text-gray-500 text-sm">
                            ...
                            <span
                                className="text-purple-600 font-semibold cursor-pointer ml-1 hover:underline">Sign Up</span>
                        </p>
                    </div>
