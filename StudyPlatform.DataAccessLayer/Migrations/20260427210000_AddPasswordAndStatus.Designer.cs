...
namespace StudyPlatform.DataAccessLayer.Migrations
{
    ...
    [Migration("20260427210000_AddPasswordAndStatus")]
    partial class AddPasswordAndStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.AttendanceEntity", b =>
                {
                    ...
                    b.Property<bool>("Present").HasColumnType("boolean");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.EventEntity", b =>
                {
                    ...
                    b.Property<Guid?>("ProfessorId").HasColumnType("uuid");
                    b.Property<string>("ProfessorName").HasColumnType("text");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.GroupEntity", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.ReportEntity", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
                    b.Property<bool>("Anonymous").HasColumnType("boolean");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.SessionEntity", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
                    b.Property<string>("CookieString").IsRequired().HasColumnType("text");
                    b.Property<DateTime>("ExpireTime").HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StudyPlatform.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<string>("LastIp").HasColumnType("text");
